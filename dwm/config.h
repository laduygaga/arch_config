...
static const Rule rules[] = {
    ...
    /* class                    instance    title           tags mask   isfloating  isterminal  noswallow   monitor */
		...
		{ "gods.exe",			NULL,       NULL,           1 << 0,		0,          1,          1,           1 },
		{ "Lutris",				NULL,       NULL,           1 << 5,		0,          0,          1,          -1 },
		{ "immutable.exe",		NULL,       NULL,           1 << 0,		0,          0,          1,           1 },
        { "St",                 NULL,       NULL,           0,          0,          1,          1,          -1 },
        { "Alacritty",          NULL,       NULL,           0,          0,          1,          1,          -1 },
		{ "gods.exe",			NULL,       NULL,           1 << 1,		0,          1,          1,          -1 },
		{ "Lutris",				NULL,       NULL,           1 << 6,		0,          0,          1,          -1 },
...
/* Custom keybinding */
    ...
    { MODKEY,               XK_m,                       spawn,  SHCMD("alacritty -e lfub /mnt/sda2/movies") },
    // { MODKEY,            XK_comma,                   spawn,  SHCMD("mpc prev") },
    // { MODKEY|ShiftMask,  XK_comma,                   spawn,  SHCMD("mpc seek 0%") },
    // { MODKEY,            XK_period,                  spawn,  SHCMD("mpc next") },
    // { MODKEY|ShiftMask,  XK_period,                  spawn,  SHCMD("mpc repeat") },
    // { 0,                 XF86XK_ScreenSaver,         spawn,  SHCMD("i3lock -k") },
    { MODKEY,               XK_F2,                      spawn,  SHCMD("i3lock -ki /home/duy/duychivas.png") },
